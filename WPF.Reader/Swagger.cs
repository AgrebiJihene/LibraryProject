...
//----------------------
// <auto-generated>
//     Generated REST API Client Code Generator v1.6.97.0 on 20/02/2023 16:29:52
...
namespace WPF.Reader.Model
{
    ...
    public partial class BookDTO : IEquatable<BookDTO>, IValidatableObject
    {
        ...
        /// <param name="author">author.</param>
        /// <param name="genres">genres.</param>
        public BookDTO(int id = default(int), string title = default(string), double price = default(double), Author author = default(Author), List<Genre> genres = default(List<Genre>))
        {
            this.Id = id;
            this.Price = price;
            this.Title = title;
